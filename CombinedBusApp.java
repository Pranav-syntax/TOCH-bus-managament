...
class busss extends JFrame implements ActionListener {
    ...
    // --- UI Components ---
    private JTextField tfName, tfFrom, tfTo, tfDate;
    private JComboBox<String> cbDepartment, cbCategory, cbYear;
    ...
    public busss() {
        ...
        addLabelAndCombo(inputPanel, gbc, row++, "Department:", labelFont, inputFont,
                new String[]{
        ...
        addLabelAndCombo(inputPanel, gbc, row++, "Year:", labelFont, inputFont,
        ...
        cbDepartment = (JComboBox<String>) inputPanel.getComponent(3);
        cbCategory = (JComboBox<String>) inputPanel.getComponent(5);
        cbYear = (JComboBox<String>) inputPanel.getComponent(7);
    ...
    private void addLabelAndCombo(JPanel panel, GridBagConstraints gbc, int row, String labelText, Font labelFont, Font inputFont, String[] options) {
        gbc.gridx = 0;
        gbc.gridy = row;
        JLabel label = new JLabel(labelText);
        label.setFont(labelFont);
    ...
    // All ticket preview code remains unchanged
    private void generateTicketInNewWindow() {
        ...
        try {
            ...
            ImageIcon ticketLogoIcon = new ImageIcon("logo.png");
